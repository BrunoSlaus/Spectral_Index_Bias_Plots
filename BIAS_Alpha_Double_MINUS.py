...
ax.set_ylim(-2.5, 2.5)
plt.scatter(Total_flux_corr*1000, -1*Spectral_index,color='black', s=2)
plt.plot(x*1000,-1*alpha_limit, color='black', linestyle='--')
plt.xscale('log')
plt.hlines(-1*0.745486, 0.0001, 10*1000, linestyle='-', color='red')
...
ax.text(0.6*1000, 2, 'Outer part', fontsize=16)
...
plt.scatter(Total_flux_corr_2*1000, -1* Spectral_index_2,color='black', s=2)
plt.plot(x*1000,-1*alpha_limit, color='black', linestyle='--')
plt.xscale('log')
plt.hlines(-1*0.646233, 0.0001, 10*1000, linestyle='-', color='red')
...
axx.text(0.6*1000,  2, 'Inner part', fontsize=16)
axx.set_xticklabels([], alpha=0.0)

plt.savefig('Plot_Final_MINUS', dpi=130)
